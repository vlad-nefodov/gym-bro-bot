...
const selectExerciseCallback = new grammy_1.Composer((ctx) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const args = (_b = (_a = ctx.callbackQuery) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.split(':');
    if (!args)
        throw new Error('selectExerciseCallback::args is undefined');
...
exports.default = selectExerciseCallback;
