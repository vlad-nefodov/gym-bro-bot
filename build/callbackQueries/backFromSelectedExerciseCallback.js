...
const backFromSelectedExerciseCallback = new grammy_1.Composer((ctx) => __awaiter(void 0, void 0, void 0, function* () {
    if (ctx.session.exercises.length === 0) {
        ...
        yield ctx.editMessageText(`📋 <b>Count</b> – ${(0, toEmojiNumbers_1.default)(ctx.session.exercises.length)}`, {
...
exports.default = backFromSelectedExerciseCallback;
